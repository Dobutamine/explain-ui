...
| Source | Role | Mark |
|---|---|---|
| `thesis/ExplainCircPaper(27012026)_WPdB_TA_WvM.docx` (Introduction) | 1.1–1.2 background/purpose seed | adapt |
| `docs/engine/README.md`, `docs/engine/ARCHITECTURE.md` | 1.2–1.3 purpose + integration story | adapt |
| `thesis/_shared-methods.md` (S1 notation, S2 factor composition, S3 advective transport, S4 cycle counters) | 1.3 integration substrate | adapt |
| `thesis/ai-parameterization-paper.md` (Introduction) | 1.4 parameterization problem | adapt |
...
| `thesis/_shared-methods.md` (S5 software, S7 reproducibility) | §2.3 software text | reuse |

### Chapter 3 — Respiratory  (Paper 2)
| Source | Role | Mark |
|---|---|---|
| `thesis/respiratory-paper.{md,docx}` | entire chapter | reuse |
...
| `thesis/Fig1_respiratory_subsystem.{png,svg}` | chapter figure | reuse |

### Chapter 4 — Regulatory organ systems  (Paper 3)
| Source | Role | Mark |
|---|---|---|
| `thesis/other-systems-paper.{md,docx}` | entire chapter | reuse |
...
| `thesis/Fig1_regulatory_systems.{png,svg}` | chapter figure | reuse |

### Chapter 5 — Devices  (Paper 5)
| Source | Role | Mark |
|---|---|---|
| `thesis/devices-paper.{md,docx}` | entire chapter | reuse |
...
| Source | Role | Mark |
|---|---|---|
| `thesis/ai-parameterization-paper.{md,docx}` (Tables 1–3, worked convergence trace) | entire chapter | reuse |
| `thesis/circ-paper-figure-AIparam.md` + `thesis/Fig6_AI_parameterization.{png,svg}` | chapter figure + caption | reuse |
...
| `thesis/circ-paper-additions.md` (blocks A, G) | source of the condensed §2.4 that stays in Ch 2 as a pointer | adapt |
...
| Source | Role | Mark |
|---|---|---|
| `thesis/_shared-methods.md` (S1–S7) | one consistent description of notation/composition/software/reproducibility, reused verbatim across chapters | reuse |
| `thesis/_references.md` | consolidated bibliography (needs verification — §5) | adapt |
| `thesis/CHANGELOG_working_docx.md` | record of circ master vs working-copy edits; drives the consistency cleanup | reference |
| `thesis/ExplainCircPaper_WORKING_with_AIparam.docx` | shows the merged-in AI-param version of Paper 1 | reference (do not use as canonical) |
...
| Respiratory subsystem schematic | `thesis/Fig1_respiratory_subsystem.{png,svg}` | Ch 3 |
| Regulatory-controller layer | `thesis/Fig1_regulatory_systems.{png,svg}` | Ch 4 |
| AI-parameterization pipeline (closed loop) | `thesis/Fig6_AI_parameterization.{png,svg}` | Ch 6 (+ pointer in Ch 2) |

### New (Fig 1.2 & Fig 7.1 produced 2026-07-10 — house-style SVG masters + 2800×2160 PNGs in `thesis/`)
